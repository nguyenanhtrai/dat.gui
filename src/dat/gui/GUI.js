...
common.extend(
  ...
  /** @lends GUI.prototype */
  {
     ...
     */
    addNameClose: function(text) {
      GUI.TEXT_CLOSED = text || GUI.TEXT_CLOSED;
    },
    addNameOpen: function(text) {
      GUI.TEXT_OPEN = text || GUI.TEXT_OPEN;
    },
    add: function(object, property, params, className) {
      return add(
        this,
        object,
        property,
     ...
     * @instance
     */
    addFolder: function(name, className = '') {
      ...
      const _className = `folder ${className}`
      dom.addClass(li, _className);
      return gui;
    },
...
function add(gui, object, property, params, className = null) {
